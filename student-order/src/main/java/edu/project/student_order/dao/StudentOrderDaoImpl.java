...
public class StudentOrderDaoImpl implements StudentOrderDao{
    ...
    private static final String INSERT_ORDER="INSERT INTO js_student_order(" +
            "            student_order_status, student_order_date, " +
            "            h_sur_name, h_given_name, h_patronymic, h_date_of_birth, h_passport_seria, " +
            ...
            "            certificate_id, register_office_id," +
            "            marriage_date)" +
            "    VALUES (?, ?, ?, " +
            "            ?, ?, ?, ?, " +
            "            ?, ?, ?, ?, " +
