...
import com.myshop.Exceptions.ValidationException;
    ...
    public class ShoppingCart implements Serializable {
        ...
        private void validateShoppingCartSize(int idProduct){
            if(products.size() > Constants.MAX_PRODUCTS_PER_SHOPPING_CART ||
                ...
                throw new ValidationException("Limit for com.myshop.ShoppingCart size reached: size="+products.size());
            }
        }
        ...
        public String toString() {
            return String.format("com.myshop.ShoppingCart [products=%s, totalCount=%s]", products, totalCount);
        }
